...
#define RST_CLR  GPIO_ResetBits(GPIOC, GPIO_Pin_0)
#define RST_SET  GPIO_SetBits(GPIOC, GPIO_Pin_0)
#define DAT_CLR  GPIO_ResetBits(GPIOC, GPIO_Pin_1)
#define DAT_SET  GPIO_SetBits(GPIOC, GPIO_Pin_1)
#define DAT_READ GPIO_ReadInputDataBit(GPIOC, GPIO_Pin_1)
#define SCK_CLR  GPIO_ResetBits(GPIOC, GPIO_Pin_2)
#define SCK_SET  GPIO_SetBits(GPIOC, GPIO_Pin_2)
